...
export class OurCommentsService extends ConvertingOurWorksClass{
  ...
  public getAllOurCommentsItems(): Observable<ICarouselImage[]>{
    ...
    .pipe(
      map((data: ICarouselImageResponse[]): ICarouselImage[] => data.map((el) => this.convertCarouselImage(el)))
    )
  }
  ...
  public updateOutCommentImage(id: number, image: File | null): Observable<ICarouselImage>{
